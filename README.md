...
1. **GPT-SoVITS** - 语音合成引擎
   ...
   - 需要预训练模型
   - 📥 [下载地址](https://www.modelscope.cn/models/FlowerCry/gpt-sovits-7z-pacakges/resolve/master/GPT-SoVITS-v2pro-20250604.7z)

2. **JoyGen** - 数字人视频生成
   - 放置于 `JoyGen/` 目录
   - 需要 Docker 镜像 `joygen:v1.0`
   - 需要预训练模型放置于 `JoyGen/pretrained_models/`
   - 📥 [预训练模型下载](https://drive.google.com/file/d/1kvGsljFRnXKUK_ETdd49jJy8DbdgZKkE/edit)
