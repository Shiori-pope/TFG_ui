...
if __name__ == "__main__":
    # root_dir = "results/preprocessed_dataset"
    ...
    import argparse
    parser = argparse.ArgumentParser(description="Preprocess dataset utilities")

    parser.add_argument(
        "--root_dir",
        type=str,
        default="results/preprocessed_dataset",
        help="The root directory containing preprocessed data."
    )

    parser.add_argument(
        "--face_list",
        type=str,
        default="face_list.txt",
        help="The name of the face list file to generate."
    )

    args = parser.parse_args()

    root_dir = args.root_dir
    face_list = args.face_list
